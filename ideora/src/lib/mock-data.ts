...
export const mockOpportunities: Opportunity[] = [
  {
    ...
    summary: 'Creators are building massive audiences by showing AI-curated morning routines. Saturation is still low (23%) with exponential search growth. Best window is next 6 days.',
    score: 87,
    window: 'open',
    saturation: 23,
    competitorCount: 142,
  ...
  },
  {
    ...
    summary: 'The narrative that one person can out-execute a full agency is exploding across X and LinkedIn. This is a prime thought leadership play with extremely low competition.',
    score: 92,
    window: 'open',
    saturation: 18,
    competitorCount: 67,
  ...
  },
  {
    ...
    trendId: 't6',
    trend: mockTrends[5],
    title: 'Mobile Cinematic B-Roll Secrets',
    summary: 'iPhone filmmaking technique searches are surging 310%/week. Tutorial and breakdown content is outperforming highly-produced studio content in this niche.',
    score: 81,
    window: 'open',
    saturation: 27,
    competitorCount: 201,
  ...
  },
  {
    ...
    trendId: 't2',
    trend: mockTrends[1],
    title: 'Mushroom Coffee Challenger Content',
    summary: 'A wave of health-focused creators are repositioning mushroom adaptogens as the future of cognitive enhancement. The "coffee replacement" narrative is performing 4x better than health claims.',
    score: 74,
    window: 'open',
    saturation: 31,
    competitorCount: 289,
  ...
  },
  {
    ...
    trendId: 't4',
    trend: mockTrends[3],
    title: 'Raw Milk Debate Response Content',
    summary: 'This controversy is at peak velocity but high saturation. The open angle is science-based debunking or nuanced "both sides" coverage — not advocacy.',
    score: 61,
    window: 'closing',
    saturation: 55,
  ...
  },
  {
    ...
    trendId: 't5',
    trend: mockTrends[4],
    title: 'ADHD Productivity System Reviews',
    summary: 'Evergreen trend with slow but consistent growth. The "what actually works for ADHD brains" review format is underserved and outperforming generic productivity content 3:1.',
    score: 68,
    window: 'open',
    saturation: 44,
    competitorCount: 612,
